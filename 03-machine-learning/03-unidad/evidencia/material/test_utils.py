...
def single_test(test_cases, target):
    ...
    if success == len(test_cases):
        print("\033[92m Todos los testeos terminados.")
    else:
        print('\033[92m', success, " Tests passed")
        print('\033[91m', len(test_cases) - success, " Tests failed")
        raise AssertionError(
            "No todos los testeos pasaron para {}. Revisa tus ecuaciones y evita utilizar variables globales dentro de la funcion.".format(target.__name__))
...
def multiple_test(test_cases, target):
    ...
    if success == len(test_cases):
        ...
        print('\033[92m', success, " Testeos han pasado")
        print('\033[91m', len(test_cases) - success, " Testeos fallaron")
        raise AssertionError(
            "No todos los testeos pasaron para {}. Revisa tus ecuaciones y evita utilizar variables globales dentro de la funcion.".format(target.__name__))
