...
class plt_one_addpt_onclick:
    ...
    def __init__(self, x, y, w, b, logistic=True):
        ...
        # only try to resize if the widget actually has rectangles or boxes
        if hasattr(self.bthresh, 'rectangles') or hasattr(self.bthresh, 'boxes'):
...
#   @output.capture()  # debug
    ...
    def resize_sq(self, bcid):
        ...
        # grab whichever internal list exists
        ...
        # flip the little check‐mark lines to match
